<style>
    ...
    .header h4 { font-size: 11pt; font-weight: bold; text-transform: uppercase; margin-bottom: 0; }
    ...
    .footer-col { display: table-cell; text-align: center; vertical-align: top; }
    .footer-title { height: 9mm; }
    .ttd-space { height: 25mm; }
    .ttd-name { font-weight: bold; text-decoration: underline; }
    .ttd-name.ttd-empty { text-decoration: none; }
